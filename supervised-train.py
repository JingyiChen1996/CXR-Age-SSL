...
# import dataset
from mixmatch_dataset import train_val_split_labeled, NIH_CXR_BASE, CxrDataset
...
def main():
    ...
    # data
    # train-val split
    # num_classes = train_val_split_labeled('~/cxr-jingyi/Age/NIH_train_10000.csv')
    num_classes = 16
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        test_iteration, test_loss, test_acc = validate(test_loader, model, num_classes, criterion, epoch, use_cuda, mode='Test Stats')
